![Image-1 (39)](https://github.com/user-attachments/assets/d773d1f0-dcc5-4bc8-b91f-bf2bce51f39e)---
layout : post
...
이후 설명할 내용은 SVM의 예측이 어떻게 이뤄지는지, 그리고 SVM의 훈련 알고리즘이 어떻게 작동하는지 설명한다. 먼저 선형 SVM 분류기부터 시작하겠다.
